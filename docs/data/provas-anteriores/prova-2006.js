...
//
// IMPORTANTE:
// O texto das questões e alternativas foi
// preservado conforme o documento original.
//
// A marcação "( X )" existente no PDF foi
// removida apenas da exibição das alternativas
// e convertida para o campo "resposta", para
// permitir a execução interativa da prova.
// =====================================


const questoesProva2006PSCPP = [
...

{
    ...
    assunto: "Cabos e sua manobra",

    topico: "Termos náuticos referentes aos cabos",

    tipo: "multipla-escolha",

    enunciado: `
Associe os termos náuticos da coluna A) com a coluna B), com relação aos termos náuticos referentes aos cabos e
...
`,
    ...
    comentario:
        "Gabarito conforme a marcação oficial ( X ) constante na prova de 2006.",

    bibliografia: [
        {
            publicacao: "Arte Naval — Maurílo M. Fonseca",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    assunto: "Código Internacional de Sinais",

    topico: "Bandeiras do Código Internacional de Sinais",

    tipo: "multipla-escolha",

    enunciado: `
Bandeira retangular nas cores preto, amarelo, azul e encarnado em quatro triângulos, formados pelas diagonais,
...
`,
    ...
    bibliografia: [
        {
            publicacao: "Código Internacional de Sinais (CIS)",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    assunto: "Cartas sinóticas",

    topico: "Cavado e circulação atmosférica",

    tipo: "multipla-escolha",

    enunciado: `
Na interpretação de uma carta sinótica de pressão ao nível do mar, o navegante identifica em uma região de
...
`,
    ...
    bibliografia: [
        {
            publicacao: "Meteorologia e Oceanografia — Lobo e Soares",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    assunto: "Sinalização náutica",

    topico: "Lista de Sinais Cegos",

    tipo: "multipla-escolha",

    enunciado: `
O Prático Roberto Carlos estava navegando em um rio quando avistou uma sinalização náutica instalada na margem
...
`,
    ...
    bibliografia: [
        {
            publicacao: "Lista de Sinais Cegos — DHN",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    topico: "Resistência friccional e camada limite",

    tipo: "multipla-escolha",

    enunciado: `
O Prático Sacramento, da asa do passadiço do navio mercante, observou o movimento turbulento da água nas
...

{
    ...
    topico: "Propulsores e sistemas de governo",

    tipo: "multipla-escolha",

    enunciado: `
Coloque (F) falso ou (V) verdadeiro nas afirmativas abaixo, em relação a propulsores e sistemas de governo
...
`,
    ...
    bibliografia: [
        ...
        {
            publicacao: "Circular da IMO Msc 1101",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    topico: "Movimento lateral de rebocador convencional",

    tipo: "multipla-escolha",

    enunciado: `
O Prático Aroldo está a bordo de um rebocador convencional, parado em relação ao fundo, equipado com dois
...
`,
    ...
    alternativas: {
        ...
        B: "máquina do propulsor de BE para ré, máquina de propulsor de BB parada, leme de BB para BE e leme de BE a meio.",
...

{
    ...
    topico: "Tipos de rebocadores",

    tipo: "multipla-escolha",

    enunciado: `
Correlacione os tipos de rebocadores, com suas características, segundo o guia “Tug Use in Port”, referência da
...
( ) Tug with azimuth propellers aft and towing point forward, built to operate manly over
the tug’s bow.

( ) Tug equipped with an additional towing point at the after end, and with 360° steerable
bow thruster.
...
`,
    ...
    bibliografia: [
        ...
        {
            publicacao: "Circular MSC 1101 — IMO",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    topico: "Segurança em operações de reboque",

    tipo: "multipla-escolha",

    enunciado: `
Atualmente, a força de tração nos cabos de reboque tem levado à ruptura de cabeços e buzinas de navios. Este fato,
...
`,
    ...
    bibliografia: [
        {
            publicacao: "Rebocadores Portuários — Otávio e Marcelo — CONAPRA",
            capitulo: "Anexo 4",
            pagina: ""
        },
        {
            publicacao: "OCIMF — Oil Companies International Marine Forum",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    assunto: "Acidentes e fatos da navegação",

    topico: "Encalhe, despacho e comunicação à Autoridade Marítima",
...
`,
    ...
    bibliografia: [
        {
            publicacao: "Normas da Autoridade Marítima Brasileira",
            capitulo: "",
            pagina: ""
        },
        {
            publicacao: "Lei de Segurança do Tráfego Aquaviário — LESTA",
            capitulo: "Art. 8°",
            pagina: ""
        }
    ]
...

{
    ...
    assunto: "Tribunal Marítimo",

    topico: "Conversão de multa em suspensão",

    tipo: "multipla-escolha",

    enunciado: `
Após ler o acórdão do Tribunal Marítimo (TM), relativo a um acidente de navegação no qual fora arrolado como
...

{
    ...
    topico: "Relação profundidade x calado",

    tipo: "multipla-escolha",

    enunciado: `
Independente de diferentes formas e tamanhos, o comportamento de qualquer navio sofre a influência de um grande
...
`,
    ...
    bibliografia: [
        {
            publicacao: "SHIPHANDLING FOR THE MARINER — Daniel H. Mac Elrevey",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    assunto: "Fundear e suspender",

    topico: "Uso do ferro como recurso de manobra",

    tipo: "multipla-escolha",

    enunciado: `
When using an anchor as a shiphandling tool, which of the following statements contains false information, according
...

{
    ...
    assunto: "Nebulosidade",

    topico: "Nuvens círrus e previsão do tempo",

    tipo: "multipla-escolha",

    enunciado: `
Um navegante observando o estado do mar e o estado do tempo, no oceano Atlântico Sul, em dia de céu limpo, sem
...

{
    ...
    assunto: "Imagem de satélite meteorológico",

    topico: "Cavado e sistema frontal",

    tipo: "multipla-escolha",

    enunciado: `
Na interpretação de uma imagem de satélite meteorológico, canal infravermelho, do oceano Atlântico Sul, as regiões
...

{
    ...
    topico: "Condição carregada e condição leve",

    tipo: "multipla-escolha",

    enunciado: `
No dia 20 de junho de 2006, a Prático Ana, em um navio VLCC, carregado, com 300.000 toneladas de porte bruto e
...
`,
    ...
    bibliografia: [
        {
            publicacao: "Princípios de Arquitetura Naval",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    assunto: "Curva de giro",

    topico: "Diâmetro tático e velocidade",

    tipo: "multipla-escolha",

    enunciado: `
O Prático Manoel, em serviço, a bordo do navio graneleiro DOCEBAY, tipo “capesize”, observou que o diâmetro tático
...
valores de diâmetro tático da curva de giro Manoel poderá manobrar o navio, quando nas condições de “HALF-AHEAD”
e “SLOW-AHEAD”:
`,
...

{
    ...
    topico: "Rebocador com cabo passado na proa",

    tipo: "multipla-escolha",

    enunciado: `
Analise as afirmativas abaixo, com relação a rebocadores com cabo passado na proa de um navio, de acordo com
...
`,
    ...
    bibliografia: [
        {
            publicacao: "Tug Use in Port — Henk Hensen",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    topico: "Método direto e indireto de reboque",

    tipo: "multipla-escolha",

    enunciado: `
Coloque falso (F) ou verdadeiro (V) nas afirmativas abaixo, em relação aos modos de operação de rebocadores com
...

{
    ...
    assunto: "Governo do navio",

    topico: "Rebocador com cabo passado na popa e estabilidade direcional",

    tipo: "multipla-escolha",

    enunciado: `
Em 1964, Moody, verificou que as qualidades de governo de alguns navios eram tão baixas que chegavam a impedir
...

{
    ...
    assunto: "Poleame e aparelhos de laborar",

    topico: "Multiplicação de potência",

    tipo: "multipla-escolha",

    enunciado: `
Assinale a afirmativa correta, com relação a poleame, aparelhos de laborar e acessórios, de acordo com Maurílo M.
...

{
    ...
    assunto: "Aparelho de fundear e suspender",

    topico: "Âncoras, amarras e fundeio",

    tipo: "multipla-escolha",

    enunciado: `
Assinale a afirmativa correta, com relação a aparelho de fundear e suspender, de acordo com Maurílo M. Fonseca, no
livro Arte Naval:
`,

    alternativas: {

        A: "A seqüência dos componentes do aparelho de fundear, a partir do braço do ferro, até o paiol da amarra, é a seguinte: - braço, pata, haste, anete, elos, tornel, amarra, boca da amarra, coroa do cabrestante, gateira, paiol da amarra, braga e paixão.",

        B: "A bóia de arinque mostra a posição do ferro em relação ao navio, devendo ser presa ao anete, com um comprimento igual a profundidade local, compensando as variações de maré.",
...

{
    ...
    topico: "Falecimento a bordo",

    tipo: "multipla-escolha",

    enunciado: `
O navio mercante “Ipanema”, arvorando bandeira brasileira, com arqueação bruta igual a 23.958, com 208m de
...
`,
    ...
    alternativas: {
        ...
        C: "Manteve embandeiramento em funeral, içando a Bandeira Nacional, à meia-adriça, tanto nos mastros como na popa, após às 12:00hs.",

        D: "Manteve embandeiramento em arco, com as bandeiras do Código Internacional de Sinais, enquanto o corpo permaneceu a bordo.",

        E: "Manteve a Bandeira Nacional no topo do mastro de popa até o por do sol, conservando-a a meia-adriça a partir desse momento, durante 3 (três) dias."
...

{
    ...
    assunto: "Serviço de Praticagem",

    topico: "Ponto de espera de Prático",

    tipo: "multipla-escolha",

    enunciado: `
O navio-tanque “Itajubá”, n° IMO 8900036, bandeira brasileira, comprimento total de 182,90 metros, boca de 32,08
...
`,
    ...
    alternativas: {
        ...
        A: "O Prático embarcou nas proximidades da bóia n° 22, pois o navio estava com calado superior a 11 (onze) metros.",

        B: "O Prático embarcou nas proximidades da bóia n° 19, pois o navio estava com calado superior a 11 (onze) metros.",

        C: "O Prático embarcou nas proximidades da BF-01, pois o navio estava com calado superior a 11 (onze) metros.",

        D: "O Prático embarcou nas proximidades do pier, pois não há restrição recomendada pela Autoridade Marítima Brasileira para navegação sem Prático.",

        E: "O Prático embarcou nas proximidades da bóia n° 19, pois apesar do calado do navio ser superior a 11 (onze) metros, trata-se de um trecho facultativo de uma Zona de Praticagem obrigatória."
...

{
    ...
    topico: "Responsabilidade das embarcações",
...

{
    ...
    topico: "Navio de um hélice e forças naturais",
...

{
    ...
    assunto: "Forças ambientais",

    topico: "Vento e ondas",
...

{
    ...
    topico: "Influência do vento relativo",
...

{
    ...
    assunto: "Trim e resistência",

    topico: "Influência do trim na resistência ao avanço",
...

{
    ...
    assunto: "Resistência de ondas",

    topico: "Sistema de ondas irradiadas pelo navio",
...

{
    ...
    topico: "Momentum theory of propeller action",
...

{
    ...
    assunto: "Manobras padrão",

    topico: "Habilidade do leme para governar o navio",
...
`,
    ...
    bibliografia: [
        {
            publicacao: "Princípios da Arquitetura Naval",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    assunto: "Navegação em canais",

    topico: "Ângulo de leme e controle em canal",
...
`,
    ...
    bibliografia: [
        {
            publicacao: "Príncipios de Arquitetura Naval",
            capitulo: "",
            pagina: ""
        },
        {
            publicacao: "NORMAM-08/DPC",
            capitulo: "",
            pagina: ""
        },
        {
            publicacao: "Approach Channels – A Guide to Design — PIANC",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    topico: "Fatores que influenciam a resistência de ondas",
...

{
    ...
    assunto: "Passage Planning",

    topico: "Margens de segurança",
...
`,
    ...
    bibliografia: [
        {
            publicacao: "BRIDGE TEAM MANAGEMENT",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    topico: "Correntes oceânicas e força de Coriolis",
...
`,
    ...
    alternativas: {
        ...
        D: "Desvio da trajetória da corrente fria no sentido anti-horário, próximo a costa do Brasil, afetando a navegação costeira.",
...

{
    ...
    topico: "Sizígia, quadratura e nível de redução",
...
`,
    ...
    alternativas: {
        ...
        B: "A altura do nível médio do mar será menor na maré de quadratura, a altura da baixamar é maior na lua nova e a amplitude da maré é menor na quadratura.",
        ...
        D: "A altura do nível médio do mar é constante nas marés de sizígia e de quadratura e pode ser igual a semi-amplitude de sizígia.",
...

{
    ...
    topico: "Parada, deriva lateral e leme",
...

{
    ...
    assunto: "Resistência friccional",

    topico: "Camada limite",
...

{
    ...
    topico: "Capacidades e limitações",
...

{
    ...
    assunto: "Parada do navio",

    topico: "Redução do seguimento",
...
`,
    ...
    alternativas: {
        ...
        C: "Realizar uma manobra de zig-zague em torno de um rumo base.",
...

{
    ...
    assunto: "Borda-livre e estabilidade",

    topico: "Critérios para embarcações nacionais",
...
`,
    ...
    bibliografia: [
        {
            publicacao: "International Regulations for Preventing Collisions at Sea, 1972 – COLREG",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    disciplina: "regulamentacao",
    assunto: "SMCP",
    topico: "Standard Marine Communication Phrases",
...
`,
    ...
    bibliografia: [
        {
            publicacao: "IMO Standard Marine Communication Phrases — Resolution A-918(22)",
            capitulo: "",
            pagina: ""
        }
    ]
...
`,
    ...
    bibliografia: [
        {
            publicacao: "Naval Shiphandling — Crenshaw",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    disciplina: "manobrabilidade",
    assunto: "Manobra a ré",
    topico: "Backing speed",
...
`,
    ...
    alternativas: {
        ...
        B: "Astern speed achieved after the ship has traveled one ship lenght.",
...
`,
    ...
    bibliografia: [
        {
            publicacao: "Arte Naval — Maurílio M. Fonseca",
            capitulo: "",
            pagina: ""
        }
    ]
...

{
    ...
    disciplina: "meteorologia",
    assunto: "Sistemas frontais",
    topico: "Frente estacionária",
...
`,
    ...
    alternativas: {
        ...
        E: "Os ventos são paralelos a frente, em ambos os lados, porém de direções opostas."
    },
...

{
    ...
    disciplina: "regulamentacao",
    assunto: "COLREG",
    topico: "Sinais sonoros em visibilidade restrita",
...

{
    ...
    disciplina: "meteorologia",
    assunto: "Circulação local",
    topico: "Brisa marítima",
...

{
    ...
    disciplina: "manobrabilidade",
    assunto: "Fundeio",
    topico: "Navio amarrado a dois ferros",
...
`,
    ...
    alternativas: {
        ...
        D: "Usar um rebocador para empurrar na alheta ou com cabo passado na popa, movendo o navio para direção desejada, colocando a corrente ou o vento no bordo apropriado, de forma que auxilie o navio a girar no sentido horário nas sucessivas marés ou mudanças de vento.",
...

{
    ...
    disciplina: "regulamentacao",
    assunto: "GMDSS",
    topico: "Reserve sources of energy",
...
`,
    ...
    alternativas: {
        ...
        D: "If a UPS or equivalent is used to supply power to the ship's GPS receiver or other source of position International Regulations for Preventing Collisions at Sea, 1972 – COLREG al information, a means must be provided to ensure the continuous supply of the information in the event of a failure to the ship's main or emergency source of power.",
...

{
    ...
    disciplina: "regulamentacao",
    assunto: "COLREG",
    topico: "Restricted in her ability to maneuver",
...

{
    ...
    disciplina: "manobrabilidade",
    assunto: "Desatracação",
    topico: "Uso combinado de máquina e rebocador",
...

{
    ...
    disciplina: "regulamentacao",
    assunto: "Código Internacional de Sinais",
    topico: "Abreviaturas e mensagens",
